            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
               <div class="container-fluid">
                  <div class="navbar-wrapper">         
                     <a class="navbar-brand" href="#">Dados Estatísticos</a>
                  </div>
               </div>
            </nav>
            <!-- End Navbar -->
            ...
            <div class="content">
              <div class="card">
            		<div class="card-header">
                    	<h5 class="title">Dados Estatísticos</h5>
                  	</div>
                  	<div class="card-body">
                  ...
                  <table class="table">
                    <thead class="text-primary">
                      <tr>
                      <th>
                        <b><span class="d-flex justify-content-center">#</span></b>
                     </th>
                     <th>
                        <b><span class="d-flex justify-content-center">Quantidade</span></b>
                     </th>
                    </tr></thead>
                    <tbody>
                   	  <tr>
                   	 	<td>Qtantidade de Tarefas Pendentes</td>	
                      	<td align="center">${estatistica.tarefasPendentes}</td>
                      </tr>
                      <tr>
                      	<td>Quantidade de Tarefas Finalizadas (esse mês)</td>	
                      	<td align="center">${estatistica.tarefasFinalizadasNoMes}</td>
                      </tr>
                      <tr>
                      	<td>Quantidade de Tarefas Finalizadas (esse ano)</td>	
                      	<td align="center">${estatistica.tarefasFinalizadasNoAno}</td>
                      </tr>
                      <tr>
                      	<td>Quantidade de Tarefas Finalizadas (total)</td>	
                      	<td align="center">${estatistica.tarefasFinalizadasNoTotal}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
