...
<html lang="pt-br" class="">
   <head>
      ...
      <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/38/11/intl/pt_br/util.js"></script>
  		...
  		<script>
  			function cadastrar(){
				document.getElementById("cadastrarTarefa").hidden = false;
				document.getElementById("cadastrarOuEscolher").hidden = true;
				document.getElementById("matricula1").disabled = true;
				
  	  	  	}

  			function cancelar(){
				document.getElementById("cadastrarTarefa").hidden = true;
				document.getElementById("cadastrarOuEscolher").hidden = false;
            ...
            <div class="content">
               <div class="card">
                  <div class="card-header">
                     <h5 class="title">Cadastrar Tarefas</h5>
                  </div>
                  <div class="card-body">
            	...
            	<div class="card">
            		<div class="card-header">
                    	<h5 class="title">Tarefas Pendentes</h5>
                  	</div>
                  	<div class="card-body">
                  ...
                  <table class="table">
                    <thead class="text-primary" style="font-size: 14px">
                      ...
                      <th>
                      	<b><span class="d-flex justify-content-center">Iniciado em:</span></b>
                      </th>
                      <th>
                      	<b><span class="d-flex justify-content-center">Finalizar</span></b>
                      </th>
                      <th>
                    ...
                    <tbody style="font-size: 14px">
                      <c:forEach var="tarefa" items="${tarefas}">
                      		<tr align="center">
                      			...
                      			<td >
                      				<form method="post" action="finalizar-tarefa">
	                      				<input type="text" value="${tarefa.idTarefa}" hidden="true" name="id">
	                      				<button type="submit" class="btn btn-success form-control"><i class="now-ui-icons ui-1_check"></i></button>
	                      			</form>
                      			</td>
                      			<td>
	                      			<form method="post" action="exibir-tarefa">
	                      				<input type="text" value="${tarefa.idTarefa}" hidden="true" name="id">
	                      				<button type="submit" class="btn btn-info form-control"><i class="now-ui-icons arrows-1_minimal-right"></i></button>
	                      			</form>
                      			</td>
                      			<td>
